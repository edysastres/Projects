...
Namespace SunatService
    ...
    Public Interface billService
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendPack", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute()>  _
        Function sendPack(ByVal request As SunatService.sendPackRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="ticket")> SunatService.sendPackResponse
    ...
    Partial Public Class billServiceClient
        ...
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatService_billService_sendPack(ByVal request As SunatService.sendPackRequest) As SunatService.sendPackResponse Implements SunatService.billService.sendPack
        ...
        Public Function sendPack(ByVal fileName As String, ByVal contentFile() As Byte, ByVal partyType As String) As String
            Dim inValue As SunatService.sendPackRequest = New SunatService.sendPackRequest
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            inValue.partyType = partyType
            Dim retVal As SunatService.sendPackResponse = CType(Me,SunatService.billService).sendPack(inValue)
